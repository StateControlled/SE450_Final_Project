...
class ScrollListComponent extends JPanel implements Scrollable {
    private int visibleRowCount;

    public ScrollListComponent(int visibleRowCount) {
        this.visibleRowCount = visibleRowCount;
        setLayout(new GridLayout(0, 1));
    }

    public void addItem(IAbstractItem item) {
        add(new ItemDisplayPanel(item));
    }
